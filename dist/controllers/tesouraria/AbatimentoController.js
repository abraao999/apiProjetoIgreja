"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }var _Abatimento = require('../../models/tesouraria/Abatimento'); var _Abatimento2 = _interopRequireDefault(_Abatimento);
var _knexfile = require('../../config/knexfile'); var _knexfile2 = _interopRequireDefault(_knexfile);

class AbatimentoController {
  async storage(req, res) {
    try {
      const dados = await _Abatimento2.default.create(req.body);
      if (!dados) {
  ...
  async maxId(req, res) {
    try {
      const dado = await _Abatimento2.default.max("id");
      if (!dado) {
...
exports. default = new AbatimentoController();
