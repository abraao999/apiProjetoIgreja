...
class LivrariaVendaController {
  async storage(req, res) {
    try {
      const dado = await _LivrariaVenda2.default.create(req.body);
      if (!dado) {
  ...
  async index(req, res) {
    const dados = await _knexfile2.default.call(void 0, "livraria_vendas")
...
exports. default = new LivrariaVendaController();
